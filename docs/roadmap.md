...
| Item | Work |
|------|------|
| 054 | Record the golden-audio clips (en+es, quiet+noisy). The CI harness is built and the full pipeline is validated against real whisper.cpp inference; only recordings are missing |
